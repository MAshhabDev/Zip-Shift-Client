                ...
                <div className="drawer-side is-drawer-close:overflow-visible">
                    ...
                    <div className="flex min-h-full flex-col items-start bg-base-200 is-drawer-close:w-14 is-drawer-open:w-64">
                        ...
                        <ul className="menu w-full grow">
                            ...
                            <li>
                                <Link to='/sendParcel' className="is-drawer-close:tooltip is-drawer-close:tooltip-right" data-tip="Settings">
                                    {/* Settings icon */}
                                    <CiDeliveryTruck />
                            ...
                            {/* Riders Link */}
                            {
                                role === 'rider' && <>
                                    ...
                                    <li>
                                        <Link to='/dashboard/completed-deliveries' className="is-drawer-close:tooltip is-drawer-close:tooltip-right" data-tip="User Management">
                                            {/* Settings icon */}
                            ...
                            {/* Admin Only Links */}
                            {
                                role === 'admin' && <>
                                    ...
                                    <li>
                                        <Link to='/dashboard/assign-riders' className="is-drawer-close:tooltip is-drawer-close:tooltip-right" data-tip="Payment-History">
                                            {/* Settings icon */}
